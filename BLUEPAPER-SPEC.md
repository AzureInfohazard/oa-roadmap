...
Sign your work. Emojis are fingerprints, not labels. Choose one that fits the architecture and the hands that built it — but don't spell out who you are. Let them find you.

A bluepaper might be signed with any mark. The mark tells you nothing about who made it. It tells you *that* someone did. The rest is for the reader to discover — if they're curious enough to look.
