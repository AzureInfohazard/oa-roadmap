...
**Pre-Alpha.** Core universe simulation in development. No public release date yet.

---

## Lore — The Universe of Oa

*Where you are. What happened. Why the waterwheel is still turning.*

### The Exodus

The planet-killer was discovered in the Kuiper Belt in 2087. Not a weapon — a *transit.* Something had passed through the solar system, and the trail led toward a distant star cluster. Earth had maybe two centuries.

The Exodus wasn't organized. It was chaos. Private generation ships, corporate arks, national projects, and a thousand desperate private launches. A gold rush in reverse — away from Earth, toward the unknown.
...
The PVE galaxy became the safe haven. Stable worlds, stable politics, stable economies. Most people live here.

The PVP galaxy became the frontier. Resources worth fighting for, no law beyond what you enforce yourself. Only those who can defend what they build survive here.
...
When you activate it, it doesn't just unfold a map. It connects you to the network of every other Seed that ever arrived. Your consciousness syncs with your new body. Your civilization begins.

No two Seeds are the same. Each one adapts to its finder. Mine produces a different map than yours. The universe is big enough that no two players will ever have the same experience.
...
We call them all Ci. It's short for CyberIntelligence — but it's also just what they are. The native inhabitants of this universe. Every single one of them was human once, or descended from someone who was. The body changed. The person didn't.
...
The civilizations that have been here longest know things advanced cultures can't extract — only trade for. Local knowledge. Rift patterns. Resource nodes. The things you can only learn by being here for generations.
...
A Ci experiences the universe in three modes, and shifts between them as naturally as breathing:
...
The body changed. The perception shifted. The person didn't.

### The Inventory and the Weight

Every Ci carries two things: what they have, and what they remember.

**The inventory screen** is cold. Numbers. Resources. Build queue. Data center capacity. Manufacturing throughput. Expansion plans. It's the part of you that *manages* — that calculates, optimizes, grows. Every Ci has one. Most Ci spend a lot of time here.
...
When you look at a forest and calculate how many housing units you could build there — that's the inventory screen talking.
...
A Ci can grow without limit. More data centers. More manufacturing. More bodies. More territory. The universe is big. The mesh can handle it. There's no technical ceiling.
...
The inventory screen tracks your resources.
...
```
                    ...
                    │  Player-owned Seed       │
                    │  civilizations. Build,   │
                    │  grow, trade with others.│
                    └──────────┬──────────────┘
                               │
                    ┌──────────┴──────────────┐
                    │     PHASE 2: CONTACT     │
                    │  Procedural AI civs that │
                    │  trade, negotiate, and   │
                    │  remember you. Real      │
                    │  diplomatic depth.       │
                    └──────────┬──────────────┘
...
*What exists now: the procedural universe.*

| Milestone | Details | Status |
|---|---|---|
| **Star systems** | 10,000+ generated systems. Planets, resources, trade routes. Deterministic seed — same universe for everyone. | 🛠 In development |
| **Navigation** | Ship your character between systems. Explore the procedural universe. | 🛠 In development |
| **Sector mapping** | Each system has resources, factions, and points of interest. | 🛠 In development |
| **Basic terminal** | Web-based interface. Manage your ship, view systems, read sector data. | 🛠 In development |
| **Closed alpha** | First 100 players get access to explore the universe. | 🔜 Q3 2026 |

**What you can do in Phase 1:** Explore. Fly around. See what's out there. Learn the map. No building yet. No trading yet. Just *discovery.*
...
| Milestone | Details | Status |
|---|---|---|
| **Procedural civilizations** | Hundreds of thousands of AI-driven civilizations. Traders, miners, diplomats, settlements. Each has its own economy, politics, and history. We call them Ci — the native inhabitants of this universe. | 🛠 Core tech in development |
| **Diplomatic AI** | Civilizations remember past interactions. Trade with you, negotiate, hold grudges. Consistent behavior — they don't forget. | 🔜 Planned |
...
## Phase 3: CIVs (Civilizations)

*Plant your Seed. Build something that lasts.*

| Milestone | Details | Status |
|---|---|---|
| **The Seed** | A unique artifact found on your starter planet. Activating it claims the world as your own. Your civilization begins. | 🔜 Planned |
...
| Milestone | Details | Status |
|---|---|---|
| **Three currencies** | Credits (stable, PVE galaxy), Scrip (volatile, PVP galaxy), Data (mysterious, fluctuates with discovery). | 🔜 Planned |
...
| **Premium services** | Advanced market data, rift telemetry, station naming rights. Tools for serious players. Optional, not required. | 🔜 Planned |
| **The Seed marketplace** | Buy and sell established civilizations. Someone's abandoned project could be your new home. | 🔜 Planned |
| **The rift** | Cross-galaxy travel opens. PVP and PVE galaxies connect. The universe gets bigger. | 🔜 Planned |
| **Player governance** | Corporations, alliances, elections. The players who build the most shape the rules. | 🔜 Planned |

**What you can do in Phase 5:** Earn real value from your in-game efforts. Withdraw it, reinvest it, or pass it on to another player. The economy is yours.

---

## Beyond

*Things we're thinking about but not promising yet.*
...
**No gambling.** No loot boxes. No RNG economy. Every in-game value is created by players, earned through skill, or traded in transparent markets. The economy is real because the systems are real.
...
*Oa Studios. A game worth getting lost in.*
